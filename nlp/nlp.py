...
def train_model(
    ...
    model.fit(x_tr, y_tr, epochs=num_epochs, batch_size=batch_size,
...
if __name__ == "__main__":
    ...
    x_tr = pad_sequences(x_tr, longest_doc_len)
    ...
    evaluate_model(x_tst, y_tst, save_model_path,
                   texts[1], tokenizer, max_len)
